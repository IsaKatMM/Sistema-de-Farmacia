package com.sistemaDeFarmacia.rest.controller.tda.list;
...
public class LinkedList<E> {
    ...
    /*
     * private void collectResults(E[] array, int mid, String attribute, String
     * value, LinkedList<E> resultList) throws Exception {
     * 
     * E midElement = array[mid];
     * Object attributeValue = exist_attribute(midElement, attribute);
     * String attributeValueStr = attributeValue.toString().toLowerCase();
    ...
    // solo en la lista se ordena con datos primitivo, si es por objetos es en los
    // daos
